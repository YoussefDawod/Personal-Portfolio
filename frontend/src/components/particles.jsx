...
const ParticlesComponent = () => {
  ...
  const [particlesColor, setParticlesColor] = useState(
    getComputedStyle(document.documentElement).getPropertyValue("--particles-color").trim()
  );
  const [backgroundColor, setBackgroundColor] = useState(
    getComputedStyle(document.documentElement).getPropertyValue("--particles-bg-color").trim()
  );
  ...
  useEffect(() => {
    ...
    const updateColors = () => {
      ...
      const bgColor = getComputedStyle(document.documentElement)
        .getPropertyValue("--particles-bg-color")
        .trim();
